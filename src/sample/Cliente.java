...
public class Cliente {
    ...
    public String eliminardatos(String nombre_esquema,String ID){
        this.armarobjetodatos("eliminar datos",nombre_esquema,ID,"","","");
        return this.conectar().getRespuesta();
    }

    public Datos buscardatos(String nombre_esquema,String dato,String columna){
        this.armarobjetodatos("buscar datos",nombre_esquema,dato,columna,"","");
        return this.conectar();
    }
    public Datos buscardatosporjoin(String nombre_esquema,String dato,String columna,String nombre_join){//usado si el parametro de busqueda es por el de un dato en un join que no sea el ID
        this.armarobjetodatos("buscar datos por join",nombre_esquema,dato,columna,"",nombre_join);
        return this.conectar();
    }
    public Datos buscardatosporindice(String nombre_esquema,String dato,String columna,String indice){
        this.armarobjetodatos("buscar datos por indice",nombre_esquema,dato,columna,indice,"");
        return this.conectar();
    }
    public String crearindice(String nombre_esquema,String columna,String indice){
        this.armarobjetodatos("crear indice",nombre_esquema,"",columna,indice,"");
        return this.conectar().getRespuesta();
    }
    public String eliminarindice(String nombre_esquema,String columna,String indice){
        this.armarobjetodatos("eliminar indice",nombre_esquema,"",columna,indice,"");
        return this.conectar().getRespuesta();
    }

    private void armarobjetodatos(String accion,String nombre,String dato,String columna, String indice, String join){
        ...
        this.datos.setNombre_join(join);
    }
