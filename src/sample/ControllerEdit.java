...
//		System.out.println(apariciones);
    ...
    public void edit(ActionEvent event) throws DatosUsadosException, EsquemaNuloException {
    	...
    	for (int x = 0; x < size; x++) {
    		System.out.println("ID CAMBIAR "+filas.get(this.newValueROW.get(x))[1]);
    		String r = this.cliente.cambiardato(e.getNombre(), filas.get(this.newValueROW.get(x))[1], this.newValueCOLUMNA.get(x), this.newValue.get(x));
    		verify = x;
