...
//        System.out.println(esquema.getID());
        ...
        Esquema esquema4=new Esquema("Esquema4,dato1:STRING:6,dato2:INT:3");
        esquema.anadirfila("daTo1:perro,dato2:222");
        esquemas.addLast(esquema4);
//        System.out.println(esquema.getID());
        Esquema esquema5=new Esquema("Esquema5,Dato1:STRING:6,Esquema1:JOIN:3");
        esquema2.anadirfila("DaCo1:raton,Esquema1:gato");
        esquema2.anadirfila("DFto1:liebre,Esquema1:perro");
        esquemas.addLast(esquema5);
        Esquema esquema6=new Esquema("Esquema6,DAto1:STRING:6,Esquema2:JOIN:3");
        esquema3.anadirfila("DAEo1:lobo,Esquema2:raton");
        esquema3.anadirfila("DAVo1:zorro,Esquema2:liebre");
        esquemas.addLast(esquema6);
